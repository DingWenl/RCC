...
if __name__ == '__main__':
    ...
    t_train_list = [1.0]
    # get the results of different numbers of training blocks
    for block_num in range(1,6):
            ...
            for sub_selelct in test_subject_list:#sub_list:
                ...
                for t_train in t_train_list:
                    ...
                    for test_block in range(6):
                        ...
                        # get the the test samples, and the number of the samples is "batchsize" 
        ...
        df.to_excel("/home/Dwl/result/test_%d.xlsx"%block_num, index=False)
